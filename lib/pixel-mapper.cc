...
class FlipPanelPixelMapper : public PixelMapper {
  public:
...
class GridPixelMapper : public PixelMapper {
  public:
	GridPixelMapper() {
	}
...
static MapperByName *CreateMapperMap() {
  ...
  RegisterPixelMapperInternal(result, new FlipPanelPixelMapper());
  RegisterPixelMapperInternal(result, new GridPixelMapper());
  return result;
}
